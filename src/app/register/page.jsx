    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#fef8f7]">
      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 p-4 lg:ml-auto lg:relative lg:p-16 bg-white rounded-lg shadow-md overflow-auto">
        ...
        <form className="space-y-4">
          ...
          <button className="bg-red-500 w-full text-white font-bold py-3 px-6 rounded-full shadow-lg hover:bg-red-600 transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce">
            Submit
          </button>
        </form>
      </div>
